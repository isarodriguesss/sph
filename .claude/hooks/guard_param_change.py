...
PARAM_NAMES = [
    'beta', 'sigma', 'k_consume', 'D_ext', 'D_int', 'D_n', 'D_n_int', 'D_o',
    'lambda_', 'lambda_ext_ratio', 'lambda_ext',
    'r_growth', 'f0', 'tension_ratio', 'c0', 'mu', 'gamma', 'gamma_mature',
    'alpha_mon', 'k_n', 'K_n', 'cs_max', 'x_dim', 'y_dim', 'h_factor',
    'rho_max', 'k_o', 'Q0',
]
